// Copyright 2023 Mourelas Konstantinos (@Mourelas Konstantinos)
...
#    define OLED_FONT_H "keyboards/moure/glcdfont.c"
#endif
...
#    define RGB_MATRIX_DEFAULT_SPD 128                                  // Sets the default animation speed, if none has been set
